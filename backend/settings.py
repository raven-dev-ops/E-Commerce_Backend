...
INSTALLED_APPS = [
    # Third-party for API and CORS
    'corsheaders',                          # <--- Make sure this is first for middleware order
    'rest_framework',
    ...
    # Mongoengine admin (leave after contrib/admin)
    'django_mongoengine',
...
# MongoDB config (using django-mongoengine)
DATABASES = {}
...
# Optionally, if you want to allow all origins (NOT RECOMMENDED FOR PROD):
